...
export class StationUI {
  ...
  renderShipyard() {
    const effects = {
      ...
      precisionHyperdrive: (t) => t.fitted ? 'No mis-jump risk · supercruise steers around bodies' : `Uncorrected emergence — ${Math.round(C.MISJUMP_CHANCE * 100)}% mis-jump risk per jump · supercruise flies blind`,
    };
